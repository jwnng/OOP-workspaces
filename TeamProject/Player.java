...
public class Player implements Moveable {
    ...
    private void checkGimmicks() { // 기믹 작동
        ...
        if (ty < 0 || ty >= Collision.tileMap.length ||
            tx < 0 || tx >= Collision.tileMap[0].length) return;
        ...
        // 2. 스위치 작동
            ...
            // 스위치 눌린 모양
            int finalState = (xSpeed > 0)
                    ? Collision.SWITCH_ON_RIGHT
                    : Collision.SWITCH_ON_LEFT;
